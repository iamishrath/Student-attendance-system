...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
     <input id="datepicker" name="dob" readonly placeholder="Please enter your date of birth" required />
  </div>
  <div class="form-group">
    <label for="image">Upload user profile </label>
  ...
  <div class="form-group form-check">
    ...
    <label class="form-check-label" for="exampleCheck1">Make sure the above information are correct</label>
  </div>
